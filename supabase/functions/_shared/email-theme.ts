...
export const DOTS_CID = "salelinx-dots";

// The site's dot-grid ground as a 24px tile. CSS radial-gradient is not usable
// here (Outlook ignores it), but a tiled image via the <td background="...">
// attribute renders essentially everywhere. Source: public/email-dot-tile.png
export const DOTS_ATTACHMENT = {
  filename: "dots.png",
  content_id: DOTS_CID,
  content: "iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAIAAABvFaqvAAAAOUlEQVR42mP8/vX9nz9/2Nk5GCgDTH/+/Pn54zsDxYDx14/PDNQATAxUAqMGjRo0atCoQaMGDR2DAGjnDtXqwl3PAAAAAElFTkSuQmCC",
} as const;

/** Every inline asset the layout references. Pass to Resend's attachments. */
export const EMAIL_ASSETS = [LOGO_ATTACHMENT, DOTS_ATTACHMENT];
...
<html lang="en">
  ...
  <body style="margin:0;padding:0;background:${theme.page};color:${theme.ink};-webkit-font-smoothing:antialiased;">
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:${theme.page};">
      <tr>
        <td background="cid:${DOTS_CID}" bgcolor="${theme.page}" style="background-color:${theme.page};background-image:url('cid:${DOTS_CID}');background-repeat:repeat;padding:44px 16px;">
