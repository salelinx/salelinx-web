-- release_notes - per-version bullet lists shown in the extension panel's
-- "Update available" banner.
--
-- Consolidated baseline (July 2026). Identical to the original migration 024.
--
...
-- See the extension repo's src/utils/updates.ts.
--
